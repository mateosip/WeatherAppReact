...
const Search = (props) => {
  const [ciudadesState, setCiudadesState] = useState(null);

  const getCiudades = (ciudad) => {
    if (ciudad) {
  ...
  return (
    <div className="Search">
      <div className="InputName">
        ...
        <div
          ...
          onClick={() =>
            ...
            getCiudades(document.getElementById("busqueda").value)
          }
        >
          Search
        </div>
      ...
      <div className="Output">
        {ciudadesState
          ? ciudadesState.map((ciudad) => {
              return (
                <div className="Mostrar" key={ciudad.place_id}>
                  <p onClick={() => props.changeCiudad(ciudad.coordinates)}>
                    {ciudad.place_name}
                  </p>
                </div>
              );
